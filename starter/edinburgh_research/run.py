    ...
    with example_sessions_dir("ex5-edinburgh-research", persist=real) as sessions_root:
        session = create_session(
            ...
            task=(
                ...
                "  3. calculate_cost(venue_id=<chosen pub's id>, party_size=6, duration_hours=3, catering_tier='bar_snacks')  <-- No need for the venue name or address here. The generate_flyer function will take care of that.\n"
